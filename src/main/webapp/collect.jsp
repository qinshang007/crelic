	...
	<script type="text/javascript">
		...
		$(function(){
			 ...
			 $('.svalue > div').click(function(){
				...
				else if(id_pre == 'b')
				{
					...
					{
						isBySelected = true;
						biaoyin = id.substring(3,id.length);
						$("#"+id).css("color","#FFAA01");
					}
					else
					{
						var lbiaoyin = 'bl_'+biaoyin;
						$("#"+lbiaoyin).css("color","#888");
						biaoyin = id.substring(3,id.length);
						$("#"+id).css("color","#FFAA01");
					}
				}
				
		         window.location.href = "/crelic/home/collections.do?userName=${username}"+
		        		 "&pageNow=1&time="+time+"&color="+color+"&biaoyin="+biaoyin;
		...
		function init()
		{
			...
			if(b!=null && b!="")
			{
				...
				isBySelected = true;
				var lbiaoyin = 'bl_' +biaoyin;
				document.getElementById(lbiaoyin).style.color="red";  
			}
  ...
  <body onload="init()">
	    ...
	    <div class="classification">
	    	...
	    	<div class="right">
	    		<div class="select">
	    			...
	    			<div class="scon" id="sort">
	    				<div class="skey" id="b_标引">标引:</div>
	    				<div class="svalue" >
		    				<c:forEach var="by" items="${bylist}">
		    					<div class="elem" id="bl_${by}">${by}</div>
			                </c:forEach>
	    				</div>
	    				<div class="soption">
	    					<ul>
    ...
    <script type="text/javascript">
		...
		kkpager.init({
			...
			//目标地址
			hrefFormer : '/crelic/home/collections.do?',
			//链接尾部
